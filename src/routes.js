...
const routes = [
  ...
  {path: '/attendance/:id',exact: true, name: 'Journey Attendance', component:Attendance },
  {path: '/bulkUpload',exact:true, name: 'Bulk Upload', component:BuldUpload},
  {path: '/Member/:id',exact:true, name: 'Edit Member', component:MemberEdit},
  {path: '/Journeysettings',exact:true, name: 'Settings', component:JourneySettings},
  {path: '/jsettings/:id',exact:true, name: 'Edit Journey', component:JourneyEdit},
