...
const routes = [
  ...
  {path: '/Member/:id', name: 'Edit Member', component:MemberEdit},
  {path: '/attendance/:id', name: 'Journey Attendance', component:Attendance },
  ...
  {path: '/jsettings/:id', name: 'Edit Journey', component:JourneyEdit},
