...
const routes = [
  ...
  {path: '/Members/:id',exact:true, name: 'Edit Member', component:MemberEdit},
  {path: '/journey',exact:true, name: 'Register Journey', component:JourneyRegistration },
  {path: '/journey/:id',exact:true, name: 'Journey Attendance', component:Attendance },
  ...
  {path: '/Journeysettings/:id',exact: true, name: 'Edit Journey', component:JourneyEdit},
