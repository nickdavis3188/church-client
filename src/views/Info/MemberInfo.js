...
const MemberInfo2 = ({match,User})=>{
  ...
  return(
	 <CCard>
		...
		<CCardBody>
		{User.role === 'admin'?<DisplayForAdmin Info={details}/>:<SubAdminDisplay Info2={details}/>}
...
const DisplayForAdmin = ({Info})=>{
	...
	let badge = Info.Sex === 'Male' || Info.Sex === 'male' || Info.Sex === 'MALE' ?'badge badge-primary':'badge badge-info'
				...
				<div className="card">
					<div className="card-body">
					  <div className="d-flex flex-column align-items-center text-center">
						...
						<div className="mt-3">
						  <h4>{Info.Surname} {Info.Firstname}</h4>
			    ...
			    <div className="card mb-3">
					<div className="card-body">
						...
						<div className="row">
							...
							<div className="col-sm-9 text-secondary">
							{Info.Dob?`${new Date(Info.Dob).getDate()} - ${monthInWords(new Date(Info.Dob).getMonth() + 1)}`:''}
							</div>
					    </div>
					    <hr/>
						...
						<div className="row">
							...
							<div className="col-sm-9 text-secondary">
							{Info.WeddingAnniversary?new Date(Info.WeddingAnniversary).toLocaleDateString():""}
							</div>
					    </div>
						<hr/>
						...
						<div className="row">
							<div className="col-sm-12">
							  <button className="btn btn-primary " target="__blank" onClick={()=> history.push(`/Members/${Info.id}`)}>Edit</button>
							</div>
						 </div>
...
const SubAdminDisplay = ({Info2})=>{
	...
	let badge2 = Info2.Sex === 'Male' || Info2.Sex === 'male' || Info2.Sex === 'MALE' ?'badge badge-primary':'badge badge-info'
	return(
			<div className="row gutters-sm">
			<div className="col-md-4 mb-3">
				<div className="card">
					<div className="card-body">
					  <div className="d-flex flex-column align-items-center text-center">
						...
						<div className="mt-3">
						  <h4>{Info2.Surname} {Info2.Firstname}</h4>
